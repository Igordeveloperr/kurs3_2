namespace DBAdmin
{
    partial class RequestUpdateForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // panel1
            // 
            panel1.Controls.Add(UpdateRequestBtn);
            ...
            // UpdateRequestBtn
            // 
            UpdateRequestBtn.BackColor = Color.Teal;
            UpdateRequestBtn.Font = new Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point, 204);
            UpdateRequestBtn.ForeColor = SystemColors.ButtonHighlight;
            UpdateRequestBtn.Location = new Point(119, 472);
            UpdateRequestBtn.Name = "UpdateRequestBtn";
            UpdateRequestBtn.Size = new Size(156, 41);
            UpdateRequestBtn.TabIndex = 12;
            UpdateRequestBtn.Text = "Обновить";
            UpdateRequestBtn.UseVisualStyleBackColor = false;
            UpdateRequestBtn.Click += UpdateRequestBtn_Click;
            // 
            // AddResidentBtn
            // 
            ...
            ClientInput.TextChanged += ClientInput_TextChanged;
