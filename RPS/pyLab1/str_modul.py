...
lib = cdll.LoadLibrary('./DLLForPy.dll')
lib.number_of_words.restype=c_int
lib.number_of_words.argtypes=[c_char_p]
number_of_wordsC = lambda text:lib.number_of_words(text.encode("ANSI"))
